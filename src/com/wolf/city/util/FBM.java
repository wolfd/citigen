...
public class FBM implements SampleMap {
     ...
     * 
     * @param octaves
     *            number of layers of Simplex noise to combine, larger values
     ...
     * @param seed
     *            is the random number generator's seed
     * @param persistence
     *            .5 is a good value for persistence. Watch out for very high
     *            octaves too.
     */
    ...
    public double noise(double x, double y) {
        ...
        for (int i = 0; i < this.octaves; i++) {
            ...
            double val =
                    (ImprovedNoise.noise(xV * frequency[i] / delta, yV
